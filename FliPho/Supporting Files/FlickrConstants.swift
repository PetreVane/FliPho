...
//struct Flickr {
//
//    static func apiEndPoint(where method: APIMethod, latitude: Double = 0, longitude: Double = 0 ) -> URL {
//
//
...
////        urlComponents.queryItems?.append(URLQueryItem(name: URLKeys.latitude, value: String(latitude)))
////        urlComponents.queryItems?.append(URLQueryItem(name: URLKeys.longitude, value: String(longitude)))
